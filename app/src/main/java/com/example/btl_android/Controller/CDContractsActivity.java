...
public class CDContractsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chu_de_contracts);
        getSupportActionBar().hide();

        lvTV = (ListView) findViewById(R.id.listviewcontracts);
        arrayTV = new ArrayList<>();
        adapter = new TuVungAdapter(CDContractsActivity.this, R.layout.dong_tu_vung, arrayTV);
...
//              Toast.makeText(CDContractsActivity.this,arrayContracts.get(position).getId(),Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void LayData(){
        ...
        String sql = "SELECT * FROM TuVung WHERE ChuDe ='Contracts'";
        ...
        while (cursor.moveToNext()){
            ...
            arrayTV.add(tu);
//            if(id == 1) tu.setHinhAnhTV(R.drawable.abide_by);
//            if(id == 2) tu.setHinhAnhTV(R.drawable.agreement);
        }
        ...
        while (cursor.moveToNext()){
            ...
            imgNutAmThanh.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    MediaPlayer mediaPlayer = MediaPlayer.create(CDContractsActivity.this,srcAt);
                    mediaPlayer.start();
                }
            });
        }
